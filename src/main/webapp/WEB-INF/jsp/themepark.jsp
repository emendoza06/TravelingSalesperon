...
<script type="text/javascript" src="/javascript/6-8Script.js"></script>
<body>
...
<style>
    body{
        margin-top: -100px;
        background-image: url('/resources/images/ThemParkBackground.png');
...
<div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-row w3-padding-64">
        ...
        <div class="w3-third w3-container">
            <h1 class="w3-text-teal" style="color: white"><b>Theme Park</b>
                <audio controls>
                    <source src = "../../resources/audio/ThemeparkAudio.mp4" type="audio/mpeg">Your browser does not support the audio element</audio>
                </audio>
            </h1>
            <p>You're on a class trip to the amusement park! How can you ride all the rides before the field trip ends? Plan the shortest route!</p>
