...
<style>
    body{
        margin-top: -100px;
        background-image: url('/resources/images/PhoneBackground.png');
...
<div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-row w3-padding-64">
        ...
        <div class="w3-third w3-container">
            <h1 class="w3-text-teal" style="color: white"><b>Lost Phone</b>
                <audio controls>
                    <source src = "../../resources/audio/PhoneAudio.mp4" type="audio/mpeg">Your browser does not support the audio element</audio>
                </audio>

            </h1>
            <p>You've lost your phone! Retrace your steps by visiting each place you've been. What's the shortest route to get to your phone quick?</p>
            <p id="startingnode"></p>
            <style>
                p#startingnode{
                    color: black;
