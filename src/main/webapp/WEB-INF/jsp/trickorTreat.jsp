...
<style>
    body{
        margin-top: -100px;
        background-image: url('/resources/images/TrickorTreatBackground.png');
...
<div class="w3-main" style="margin-left:250px">
    ...
    <div class="w3-row w3-padding-64">
        ...
        <div class="w3-third w3-container">
            <h1 class="w3-text-teal" style="color: white"><b>Trick or Treat</b>
                <audio controls>
                    <source src = "../../resources/audio/TrickorTreatAudio.mp4" type="audio/mpeg">Your browser does not support the audio element</audio>
                </audio>
            </h1>
            <p>It's Halloween and you're trick-or-treating with your friends. Plan the shortest route to collect all the candy in your neighborhood before it's lights out.</p>
            <p id="startingnode"></p>
            <style>
                p#startingnode{
                    color: black;
